...
public class hard_mode extends AppCompatActivity {
    ...
    public int miss = 1;
    public int score = 0;
    public ImageView imgNum1, imgNum2, imgNum3, imgEq, imgEq2, ice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setBackgroundResource(R.drawable.hardcity1);
        ...
        count = new CountDownTimer(30000, 1) {
            @Override
    ...
    public void CheckAns(int val){
        if(val != anspos){
            wrongsound.start();
            ice.setImageResource(getResourcesId(this, /*"hard"*/"eat" + ++miss, "drawable"));
            if(miss == 6){
                count.cancel();
                endsound.start();
    ...
    private void saveScore(){
        ...
        String strFileContents = Username + "\t\t\t\t\t\t Hard \t\t\t\t\t\t\t\t" + score +"\n";
        try {
